...
```toml
[dependencies]
atauth = { git = "https://gitea.cloudforest-basilisk.ts.net/Arcnode.xyz/atauth" }
```
...
```toml
[dependencies]
atauth = { git = "https://gitea.cloudforest-basilisk.ts.net/Arcnode.xyz/atauth", features = ["session-sqlite", "rate-limit"] }
```
