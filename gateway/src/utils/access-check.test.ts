...
describe('matchHandlePattern', () => {
  ...
  it('should match suffix pattern "*.domain"', () => {
    expect(matchHandlePattern('*.example.com', 'user.example.com')).toBe(true);
  ...
  it('should match exact handle', () => {
    expect(matchHandlePattern('user.example.com', 'user.example.com')).toBe(true);
  });

  it('should not match different exact handle', () => {
    expect(matchHandlePattern('user.example.com', 'other.example.com')).toBe(false);
  });
